...
import { X, Lock, User, Mail, Phone, MapPin, Loader2, Eye, EyeOff, AlertCircle } from "lucide-react";
...
export default function EmployeeFormModal({ isOpen, onClose, onSubmit, initialData, isLoading = false, error, clearError }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Clean optional/conditional fields
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-left text-xs font-sans">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="email"
                placeholder="rahul@empireplaza.com"
          ...
          >
            {isLoading ? <Loader2 size={16} className="animate-spin" /> : (initialData ? "Update Employee" : "Create Employee")}
          </button>
        </form>
      </div>
    </div>
